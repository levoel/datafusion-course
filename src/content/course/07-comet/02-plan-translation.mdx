...
<DiagramContainer title="Иерархия protobuf-сообщений" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <FlowNode variant="output">Spark PhysicalPlan (JVM)</FlowNode>
    <Arrow direction="down" label="CometExecRule" />
    <FlowNode variant="process">CometExec (Scala)</FlowNode>
    <Arrow direction="down" label="serialize to protobuf" />
    <FlowRow className="gap-4 justify-center flex-wrap">
      <DataBox label="Operator" className="border-blue-500/30 text-xs">
        <div>Filter, Project,</div>
        <div>Aggregate, Join, Sort</div>
      </DataBox>
      <DataBox label="Expr" className="border-blue-500/30 text-xs">
        <div>Literal, ColumnRef,</div>
        <div>BinaryExpr, Cast, ScalarFunc</div>
      </DataBox>
      <DataBox label="DataType" className="border-blue-500/30 text-xs">
    ...
    <FlowNode variant="input">DataFusion ExecutionPlan</FlowNode>
  </FlowColumn>
</DiagramContainer>
...
<DiagramContainer title="All-or-nothing fallback" className="my-6">
  <Grid columns={2} className="gap-4 text-sm">
    <DataBox label="Все операторы поддерживаются" className="border-emerald-500/30">
      <FlowColumn className="gap-1 p-2">
        <FlowNode variant="process">CometFilterExec</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="process">CometProjectExec</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="process">CometScanExec</FlowNode>
      </FlowColumn>
      <div className="text-xs text-center mt-2 text-emerald-400">Весь stage нативный</div>
    </DataBox>
    <DataBox label="Один оператор не поддерживается" className="border-orange-500/30">
      <FlowColumn className="gap-1 p-2">
        <FlowNode variant="process">Spark FilterExec</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="process">Spark ProjectExec</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="process">Spark ScanExec</FlowNode>
      </FlowColumn>

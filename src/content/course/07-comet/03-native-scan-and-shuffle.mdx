...
<DiagramContainer title="Три пути нативного scan" className="my-6">
  <FlowColumn className="p-4 gap-2">
    ...
    <FlowRow className="gap-3 justify-center flex-wrap">
      ...
      <DataBox label="native_datafusion" className="border-blue-500/30 text-xs" tooltip="Стандартный DataSourceExec DataFusion — лучше для сложных типов, асинхронное I/O через Tokio">
        <div className="font-semibold">DataFusion reader</div>
        <div className="mt-1">Стандартный DataSourceExec DataFusion</div>

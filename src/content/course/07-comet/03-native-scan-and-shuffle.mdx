...
<DiagramContainer title="Три пути нативного scan" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <FlowNode variant="input">Parquet файл</FlowNode>
    <Arrow direction="down" label="spark.comet.scan.impl" />
    <FlowRow className="gap-3 justify-center flex-wrap">
      <DataBox label="native_comet" className="border-emerald-500/30 text-xs">
      ...
      <DataBox label="native_datafusion" className="border-blue-500/30 text-xs">
      ...
      <DataBox label="native_iceberg_compat" className="border-purple-500/30 text-xs">
    ...
    <FlowNode variant="output">Arrow RecordBatch</FlowNode>
  </FlowColumn>
</DiagramContainer>
...
<DiagramContainer title="Spark shuffle vs Comet columnar shuffle" className="my-6">
  <Grid columns={2} className="gap-4 text-sm">
    <DataBox label="Стандартный Spark shuffle" className="border-orange-500/30">
      <FlowColumn className="gap-1 p-2">
        <FlowNode variant="process">Arrow RecordBatch</FlowNode>
        <Arrow direction="down" label="ColumnarToRow" />
        <FlowNode variant="process">UnsafeRow (serialized)</FlowNode>
        <Arrow direction="down" label="network / disk" />
        <FlowNode variant="process">UnsafeRow (deserialized)</FlowNode>
        <Arrow direction="down" label="RowToColumnar" />
        <FlowNode variant="output">Arrow RecordBatch</FlowNode>
      </FlowColumn>
    </DataBox>
    <DataBox label="Comet columnar shuffle" className="border-emerald-500/30">
      <FlowColumn className="gap-1 p-2">
        <FlowNode variant="process">Arrow RecordBatch</FlowNode>
        <Arrow direction="down" label="partition by key" />
        <FlowNode variant="process">Arrow IPC (columnar)</FlowNode>
        <Arrow direction="down" label="network / disk" />
        <FlowNode variant="output">Arrow RecordBatch</FlowNode>
      </FlowColumn>
    </DataBox>

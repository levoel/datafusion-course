...
<DiagramContainer title="Сравнение Spark-ускорителей" className="my-6">
  <Grid columns={3} className="gap-3 text-sm">
    <DataBox label="Apache Comet" className="border-emerald-500/30">
    ...
    <DataBox label="Gluten + Velox" className="border-blue-500/30">
    ...
    <DataBox label="Databricks Photon" className="border-purple-500/30">

...
<DiagramContainer title="Spark-запрос: без Comet и с Comet" className="my-6">
  <Grid columns={2} className="gap-4 text-sm">
    <DataBox label="Без Comet (стандартный Spark)" className="border-orange-500/30">
      <FlowColumn className="gap-1 p-2">
        <FlowNode variant="input">SQL / DataFrame API</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="process">Catalyst Optimizer</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="process">Spark Physical Plan</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="process">Whole-Stage CodeGen (JVM)</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="output">InternalRow (row-based)</FlowNode>
      </FlowColumn>
    </DataBox>
    <DataBox label="С Comet" className="border-emerald-500/30">
      <FlowColumn className="gap-1 p-2">
        <FlowNode variant="input">SQL / DataFrame API</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="process">Catalyst Optimizer</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="process">CometExecRule (замена операторов)</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="process">DataFusion ExecutionPlan (native)</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="output">Arrow RecordBatch (columnar)</FlowNode>
      </FlowColumn>
    </DataBox>
  </Grid>
</DiagramContainer>
...
<DiagramContainer title="Архитектура CometPlugin" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <FlowNode variant="input">SparkSession (spark.plugins = CometPlugin)</FlowNode>
    <Arrow direction="down" />
    <FlowNode variant="process">CometSparkSessionExtensions</FlowNode>
    <Arrow direction="down" />
    <FlowRow className="gap-4 justify-center">
      <FlowNode variant="process">CometScanRule</FlowNode>
      <FlowNode variant="process">CometExecRule</FlowNode>
    </FlowRow>
    <Arrow direction="down" label="protobuf + JNI" />
    <FlowNode variant="decision">Rust: PhysicalPlanner (planner.rs)</FlowNode>
    <Arrow direction="down" />
    <FlowNode variant="output">DataFusion ExecutionPlan</FlowNode>
  </FlowColumn>
</DiagramContainer>

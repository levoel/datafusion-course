...
<DiagramContainer title="Стратегии RepartitionExec" className="my-6">
  <Grid columns={3} className="gap-3 text-sm">
    <DataBox label="RoundRobin" className="border-blue-500/30">
    ...
    <DataBox label="Hash" className="border-emerald-500/30">
    ...
    <DataBox label="UnknownPartitioning" className="border-amber-500/30">
...
<DiagramContainer title="Однопроцессное vs распределённое перераспределение" className="my-6">
  <Grid columns={2} className="gap-4 text-sm">
    <DataBox label="Один процесс (DataFusion)" className="border-blue-500/30">
      <FlowColumn className="gap-1 p-2">
        <FlowNode className="bg-blue-950/60 text-xs p-1">Поток 1 (партиция 0)</FlowNode>
        <FlowNode className="bg-blue-950/60 text-xs p-1">Поток 2 (партиция 1)</FlowNode>
        <Arrow direction="down" />
        <FlowNode className="bg-blue-700/40 text-xs p-1 border border-blue-400/30">RepartitionExec (crossbeam channels)</FlowNode>
        <Arrow direction="down" />
        <FlowNode className="bg-blue-950/60 text-xs p-1">Поток 3 (партиция 0')</FlowNode>
        <FlowNode className="bg-blue-950/60 text-xs p-1">Поток 4 (партиция 1')</FlowNode>
      </FlowColumn>
    </DataBox>
    <DataBox label="Распределённая система" className="border-emerald-500/30">
      <FlowColumn className="gap-1 p-2">
        <FlowNode className="bg-emerald-950/60 text-xs p-1">Executor A (партиция 0)</FlowNode>
        <FlowNode className="bg-emerald-950/60 text-xs p-1">Executor B (партиция 1)</FlowNode>
        <Arrow direction="down" />
        <FlowNode className="bg-emerald-700/40 text-xs p-1 border border-emerald-400/30">Shuffle (Arrow IPC по сети)</FlowNode>
        <Arrow direction="down" />
        <FlowNode className="bg-emerald-950/60 text-xs p-1">Executor C (партиция 0')</FlowNode>
        <FlowNode className="bg-emerald-950/60 text-xs p-1">Executor D (партиция 1')</FlowNode>
      </FlowColumn>
    </DataBox>
  </Grid>
</DiagramContainer>
...
<DiagramContainer title="Компоненты распределённого выполнения" className="my-6">
  <FlowRow className="gap-4 text-sm items-start">
    <DataBox label="Координация" className="border-blue-500/30 flex-1">
    ...
    <DataBox label="Shuffle" className="border-emerald-500/30 flex-1">
    ...
    <DataBox label="Отказоустойчивость" className="border-amber-500/30 flex-1">

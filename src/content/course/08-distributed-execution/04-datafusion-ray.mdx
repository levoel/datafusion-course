...
<DiagramContainer title="DataFusion Ray: архитектура" className="my-6">
  <FlowColumn className="gap-4 text-sm">
    <DataBox label="Python Driver" className="border-blue-500/30 mx-auto">
      <FlowRow className="gap-3 p-2">
        <FlowNode className="bg-blue-950/60 text-xs p-1">DataFusion Context</FlowNode>
        <FlowNode className="bg-blue-950/60 text-xs p-1">Query Planner</FlowNode>
        <FlowNode className="bg-blue-950/60 text-xs p-1">Stage Splitter</FlowNode>
      </FlowRow>
    </DataBox>
    <Arrow direction="down" label="execute_query_stage.remote()" />
    <FlowRow className="gap-3 justify-center">
      <DataBox label="Ray Worker 1" className="border-emerald-500/30">
        <div className="text-xs">DataFusion runtime</div>
        <div className="text-xs mt-1 font-mono">ShuffleWriterExec</div>
      </DataBox>
      <DataBox label="Ray Worker 2" className="border-emerald-500/30">
        <div className="text-xs">DataFusion runtime</div>
        <div className="text-xs mt-1 font-mono">ShuffleWriterExec</div>
      </DataBox>
      <DataBox label="Ray Worker N" className="border-emerald-500/30">
        <div className="text-xs">DataFusion runtime</div>
        <div className="text-xs mt-1 font-mono">ShuffleWriterExec</div>
      </DataBox>
    </FlowRow>
    <Arrow direction="down" label="Arrow IPC на общей файловой системе" />
    <FlowNode className="bg-gray-800/60 text-xs p-2 mx-auto">Shared filesystem (NFS / объектное хранилище)</FlowNode>
  </FlowColumn>
</DiagramContainer>
...
<DiagramContainer title="Ограничения DataFusion Ray (март 2026)" className="my-6">
  <Grid columns={2} className="gap-3 text-sm">
    <DataBox label="Shared filesystem" className="border-amber-500/30">
    ...
    <DataBox label="Batch mode" className="border-amber-500/30">
    ...
    <DataBox label="~1700 LOC" className="border-amber-500/30">
    ...
    <DataBox label="Нет production-историй" className="border-amber-500/30">

...
<DiagramContainer title="Arrow IPC Stream Format" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <DataBox label="Schema Message" className="border-slate-400/30 w-64 mx-auto">
      <div className="text-xs">Схема (Field names, DataTypes, metadata)</div>
    </DataBox>
    <Arrow direction="down" />
    <DataBox label="RecordBatch Message #1" className="border-blue-500/30 w-64 mx-auto">
      <div className="text-xs">Metadata + Body (буферы колонок)</div>
    </DataBox>
    <Arrow direction="down" />
    <DataBox label="RecordBatch Message #2" className="border-blue-500/30 w-64 mx-auto">
      <div className="text-xs">Metadata + Body (буферы колонок)</div>
    </DataBox>
    <Arrow direction="down" />
    <DataBox label="..." className="border-blue-400/20 w-64 mx-auto">
      <div className="text-xs">Ещё RecordBatch сообщения</div>
    </DataBox>
    <Arrow direction="down" />
    <DataBox label="EOS (End of Stream)" className="border-red-500/30 w-64 mx-auto">
...
<DiagramContainer title="Arrow IPC File Format" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <DataBox label="Magic: ARROW1" className="border-slate-400/30 w-64 mx-auto">
      <div className="text-xs">6 байт magic number</div>
    </DataBox>
    <Arrow direction="down" />
    <DataBox label="RecordBatch блоки" className="border-blue-500/30 w-64 mx-auto">
      <div className="text-xs">Schema + RecordBatch messages (как в stream)</div>
    </DataBox>
    <Arrow direction="down" />
    <DataBox label="Footer" className="border-emerald-500/30 w-64 mx-auto">
...
<DiagramContainer title="Arrow Flight: клиент-серверное взаимодействие" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <FlowRow className="gap-4 justify-center flex-wrap">
      <FlowNode variant="input">Flight Client</FlowNode>
      <FlowNode variant="output">Flight Server</FlowNode>
    </FlowRow>
    <Arrow direction="down" />
    <DataBox label="Flight Protocol (gRPC)" className="border-blue-500/30 w-72 mx-auto">
      <div className="text-xs space-y-1">
    ...
    <Arrow direction="down" />
    <DataBox label="Данные: Arrow IPC RecordBatch" className="border-emerald-500/30 w-72 mx-auto">

...
<DiagramContainer title="Row Storage vs Column Storage" className="my-6">
  <FlowRow className="gap-6 justify-center flex-wrap">
    <DataBox label="Row Storage (OLTP)" className="border-red-500/30 w-56">
    ...
    <DataBox label="Column Storage (OLAP)" className="border-emerald-500/30 w-56">
      <div className="text-xs space-y-1 font-mono">
        <div>id:     [1, 2, 3]</div>
...
<DiagramContainer title="Zero-Copy в действии" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <FlowRow className="gap-3 justify-center flex-wrap">
      ...
      <FlowNode variant="input">Java (Arrow Java)</FlowNode>
    </FlowRow>
    <Arrow direction="down" />
    <Tooltip content="Все реализации работают с одним byte layout. Shared memory pointer вместо сериализации.">
      <DataBox label="Arrow Memory (один byte layout)" className="border-blue-500/30 w-72 mx-auto">
    ...
    <Arrow direction="down" />
    <FlowNode variant="output">Обработка без десериализации</FlowNode>
  </FlowColumn>
</DiagramContainer>

...
<DiagramContainer title="Трёхфазный конвейер оптимизации" className="my-6">
  <FlowColumn className="p-4 gap-2">
    ...
    <FlowNode variant="process">Фаза 1: Analyzer (AnalyzerRules)</FlowNode>
    <Arrow direction="down" label="Resolved LogicalPlan" />
    <FlowNode variant="process">Фаза 2: Logical Optimizer (OptimizerRules)</FlowNode>
    <Arrow direction="down" label="Optimized LogicalPlan" />
    <FlowNode variant="process">Фаза 3: Physical Optimizer (PhysicalOptimizerRules)</FlowNode>
    <Arrow direction="down" label="Optimized ExecutionPlan" />
    <FlowNode variant="output">Выполнение (RecordBatch stream)</FlowNode>
  </FlowColumn>
</DiagramContainer>

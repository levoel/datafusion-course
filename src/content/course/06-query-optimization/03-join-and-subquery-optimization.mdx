...
<DiagramContainer title="Алгоритмы JOIN в DataFusion" className="my-6">
  <Grid columns={3} className="gap-4 text-sm">
    <DataBox label="HashJoinExec" className="border-blue-500/30">
    ...
    <DataBox label="SortMergeJoinExec" className="border-emerald-500/30">
    ...
    <DataBox label="NestedLoopJoinExec" className="border-red-500/30">

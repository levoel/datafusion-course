...
<CrossCourseRef
  ...
  lessonSlug="02-catalyst-tungsten/02-logical-plan-analysis"
  label="Spark Catalyst: те же правила в JVM"
  preview="Как Spark Catalyst применяет predicate pushdown, projection pushdown и constant folding — параллельный набор правил в JVM-движке."
/>

<CrossCourseRef
  courseId="clickhouse-course"
  lessonSlug="06-query-engine/07-new-analyzer"
  label="ClickHouse: New Analyzer"
  preview="Полностью переписанный SQL-аналитор ClickHouse — как он строит и оптимизирует план, сходства и отличия с DataFusion Optimizer."
/>

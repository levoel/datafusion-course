...
<DiagramContainer title="Диагностика по метрикам EXPLAIN ANALYZE" className="my-6">
  <Grid columns={2} className="gap-4 text-sm">
    <DataBox label="row_groups_pruned = 0" className="border-red-500/30">
    ...
    <DataBox label="spill_count > 0" className="border-red-500/30">
    ...
    <DataBox label="bytes_scanned высок" className="border-yellow-500/30">
    ...
    <DataBox label="NestedLoopJoin на больших таблицах" className="border-yellow-500/30">

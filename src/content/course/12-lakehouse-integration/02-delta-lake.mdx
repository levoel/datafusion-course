...
<Callout type="tip">
Для углублённого изучения внутренней архитектуры Delta Lake (transaction log, checkpoints, ACID-гарантии, data skipping) см. курс [Storage Formats Deep-Dive](/storage-formats/11-delta-lake/01-transaction-log-architecture/).
</Callout>

...
<CrossCourseRef
  ...
  lessonSlug="13-realtime-analytics/01-realtime-analytics"
  label="Real-time analytics в data-platform"
  preview="Где single-node DataFusion / Iceberg-зернистая аналитика встаёт в архитектуру real-time analytics поверх lakehouse."
/>

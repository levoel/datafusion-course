...
<DiagramContainer title="UDF Execution Flow" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <FlowNode variant="input">SQL: SELECT my_func(col_a, col_b) FROM t</FlowNode>
    <Arrow direction="down" label="Каталог функций" />
    <FlowNode variant="process">ScalarUDF lookup по имени</FlowNode>
    <Arrow direction="down" label="Физическое выполнение" />
    <FlowNode variant="process">invoke_with_args(ScalarFunctionArgs)</FlowNode>
    <Arrow direction="down" label="Vectorized execution" />
    <FlowNode variant="output">Arrow Array (результат)</FlowNode>
  </FlowColumn>
</DiagramContainer>
...
<DiagramContainer title="Варианты Signature" className="my-6">
  <Grid columns={2} className="gap-4 text-sm">
    <DataBox label="Uniform" className="border-blue-500/30">
    ...
    <DataBox label="Exact" className="border-emerald-500/30">
    ...
    <DataBox label="Variadic" className="border-yellow-500/30">
    ...
    <DataBox label="OneOf" className="border-purple-500/30">

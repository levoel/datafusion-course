...
<DiagramContainer title="Точки расширения DataFusion" className="my-6">
  <Grid columns={2} className="gap-4 text-sm">
    <DataBox label="Данные" className="border-blue-500/30" tooltip="Точки расширения для подключения произвольных источников данных и форматов файлов">
    ...
    <DataBox label="Вычисления" className="border-emerald-500/30" tooltip="Расширение вычислительных возможностей: скалярные, агрегатные, оконные и табличные функции">
    ...
    <DataBox label="Планирование" className="border-yellow-500/30" tooltip="Расширение планировщика: собственные логические операторы и их физическая реализация">
    ...
    <DataBox label="SQL-синтаксис" className="border-purple-500/30" tooltip="Расширение SQL-синтаксиса: динамическое создание функций и таблиц через DDL-команды">

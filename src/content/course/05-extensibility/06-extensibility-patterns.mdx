...
<DiagramContainer title="Библиотека vs Фреймворк" className="my-6">
  <Grid columns={2} className="gap-4 text-sm">
    <DataBox label="Библиотека (Embedding)" className="border-blue-500/30">
    ...
    <DataBox label="Фреймворк (Extension)" className="border-emerald-500/30">
...
<DiagramContainer title="Когда использовать какую точку расширения" className="my-6">
  <Grid columns={1} className="gap-2 text-sm">
    <DataBox label="Задача → Точка расширения" className="border-gray-500/30">

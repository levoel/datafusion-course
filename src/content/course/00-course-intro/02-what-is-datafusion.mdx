...
<CrossCourseRef
  ...
  lessonSlug="03-batch-processing/02-batch-pipeline-patterns"
  label="System Design: батч-pipelines"
  preview="Где DataFusion (single-node Arrow-native engine) находит место в архитектуре батчевого pipeline'а — рядом с Spark и dbt."
/>

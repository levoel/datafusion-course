...
<DiagramContainer title="Позиционирование DataFusion" className="my-6">
  <Grid columns={2} className="gap-4 text-sm">
    <DataBox label="DataFusion" className="border-blue-500/30">
    ...
    <DataBox label="Pandas" className="border-yellow-500/30">
    ...
    <DataBox label="Polars" className="border-emerald-500/30">
    ...
    <DataBox label="DuckDB" className="border-purple-500/30">

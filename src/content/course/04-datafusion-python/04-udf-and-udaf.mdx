...
<DiagramContainer title="Volatility: уровни" className="my-6">
  <Grid columns={3} className="gap-4 text-sm">
    <DataBox label="immutable" className="border-emerald-500/30">
    ...
    <DataBox label="stable" className="border-yellow-500/30">
    ...
    <DataBox label="volatile" className="border-red-500/30">

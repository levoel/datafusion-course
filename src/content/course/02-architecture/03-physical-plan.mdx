...
<DiagramContainer title="Партиционирование и параллелизм" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <FlowNode variant="process">CoalescePartitionsExec</FlowNode>
    <Arrow direction="down" label="1 партиция" />
    <FlowNode variant="process">SortExec (ORDER BY total DESC)</FlowNode>
    <Arrow direction="down" />
    <FlowNode variant="process">AggregateExec (final merge)</FlowNode>
    ...
    <FlowRow className="gap-4 justify-center flex-wrap">
      <FlowColumn className="gap-1 items-center">
        <FlowNode variant="process">AggregateExec (partial)</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="input">ParquetExec (part 0)</FlowNode>
      </FlowColumn>
      <FlowColumn className="gap-1 items-center">
        <FlowNode variant="process">AggregateExec (partial)</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="input">ParquetExec (part 1)</FlowNode>
      </FlowColumn>
      <FlowColumn className="gap-1 items-center">
        <FlowNode variant="process">AggregateExec (partial)</FlowNode>
        <Arrow direction="down" />
        <FlowNode variant="input">ParquetExec (part 2)</FlowNode>
      </FlowColumn>
    </FlowRow>
  </FlowColumn>
</DiagramContainer>

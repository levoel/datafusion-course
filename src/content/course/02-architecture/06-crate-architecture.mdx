...
<DiagramContainer title="DataFusion Crate Dependency Graph" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <FlowNode variant="output">datafusion (meta-crate)</FlowNode>
    <Arrow direction="down" />
    <FlowRow className="gap-4 justify-center flex-wrap">
      <FlowNode variant="process">datafusion-sql</FlowNode>
      <FlowNode variant="process">datafusion-optimizer</FlowNode>
      <FlowNode variant="process">datafusion-physical-plan</FlowNode>
    </FlowRow>
    <Arrow direction="down" />
    <FlowRow className="gap-4 justify-center flex-wrap">
      <FlowNode variant="process">datafusion-expr</FlowNode>
      <FlowNode variant="process">datafusion-physical-expr</FlowNode>
      <FlowNode variant="process">datafusion-execution</FlowNode>
    </FlowRow>
    <Arrow direction="down" />
    <FlowRow className="gap-4 justify-center flex-wrap">
      <FlowNode variant="process">datafusion-functions</FlowNode>
      <FlowNode variant="process">datafusion-catalog</FlowNode>
    </FlowRow>
    <Arrow direction="down" />
    <FlowNode variant="input">datafusion-common (+ arrow-rs)</FlowNode>
  </FlowColumn>
</DiagramContainer>

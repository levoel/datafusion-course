...
<DiagramContainer title="Catalog Hierarchy" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <DataBox label="CatalogProvider" className="border-blue-500/30 w-64 mx-auto">
      <div className="text-xs font-mono">name: "datafusion" (по умолчанию)</div>
    </DataBox>
    <Arrow direction="down" />
    <DataBox label="SchemaProvider" className="border-yellow-500/30 w-64 mx-auto">
      <div className="text-xs font-mono">name: "public" (по умолчанию)</div>
    </DataBox>
    <Arrow direction="down" />
    <FlowRow className="gap-4 justify-center flex-wrap">
      <DataBox label="TableProvider" className="border-emerald-500/30 w-36">

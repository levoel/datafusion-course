...
<DiagramContainer title="Концепция оконного фрейма" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <FlowRow className="gap-3 justify-center">
      <DataBox label="Partition: region = 'EU'" className="border-blue-500/30 w-80" tooltip="Раздел данных — все строки с region='EU', упорядоченные по amount">
    ...
    <FlowRow className="gap-3 justify-center">
      <DataBox label="Фрейм для row 3" className="border-emerald-500/30 w-80" tooltip="Оконный фрейм — подмножество строк раздела для текущего вычисления">
        <div className="text-xs font-mono space-y-1">
    ...
    <FlowNode variant="output" tooltip="Результат AVG(amount) по фрейму: (200+350+400)/3 = 316.67">316.67</FlowNode>
  </FlowColumn>
</DiagramContainer>

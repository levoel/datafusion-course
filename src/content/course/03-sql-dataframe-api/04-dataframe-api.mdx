...
<DiagramContainer title="DataFrame: ленивое построение плана" className="my-6">
  <FlowColumn className="p-4 gap-2">
    <FlowNode variant="input">ctx.table("orders")</FlowNode>
    ...
    <FlowNode variant="process">DataFrame (LogicalPlan: Sort)</FlowNode>
    <Arrow direction="down" label=".collect() — ВЫПОЛНЕНИЕ" />
    <FlowNode variant="output">Vec&lt;RecordBatch&gt;</FlowNode>
  </FlowColumn>
</DiagramContainer>
